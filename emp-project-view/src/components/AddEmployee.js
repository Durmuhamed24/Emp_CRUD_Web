...
function AddEmployee() {
  ...
  return (
    <div className='max-w-xl mx-40 bg-slate-800 rounded shadow py-4 px-8'> 
        ...
        onChange={(e)=> handlechange(e)} className="w-full py-2 my-4 text-slate-800" placeholder="Name"></input>
        <input type='number' name='phone' value={employee.phone} onChange={(e)=> handlechange(e)} className="w-full py-2 my-4 text-slate-800" placeholder='Phone'></input>
        <input type='email' name='email' value={employee.email} onChange={(e)=> handlechange(e)} className="w-full py-2 my-4 text-slate-800" placeholder='Email'></input>
        </div>
